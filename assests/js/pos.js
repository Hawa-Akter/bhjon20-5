...
//cartItems On POS
ipcRenderer.on("replySentFromCartItems", (evt, x) => {
  var cartTable = document.getElementById("cartItems");
  cartTable.innerHTML = "";
  var tableContents = "";

  tableContents = `<table class="table table-bordered" style="margin-top: 5rem;">
    <thead>
        <tr>
            <th>Item</th>
            <th>Varient</th>
...
function getFoodId(id) {
  ...
  let addOnItems = knex("foods")
    .join("add_on_assign", "add_on_assign.food_id", "foods.id")
